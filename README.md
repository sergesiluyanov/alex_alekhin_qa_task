...
├── cypress/
│   ├── e2e/                    # Тесты
│   │   ├── login.cy.js        # Пример тестов для страницы логина
│   │   ├── home.cy.js         # Пример тестов для главной страницы
│   │   └── example.cy.js      # Базовый пример теста
│   ├── fixtures/              # Тестовые данные
│   │   └── example.json
│   ├── pages/                 # Page Object классы
│   │   ├── BasePage.js        # Базовый класс для всех страниц
│   │   ├── LoginPage.js       # Page Object для страницы логина
